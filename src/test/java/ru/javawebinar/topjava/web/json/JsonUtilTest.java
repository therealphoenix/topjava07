...
public class JsonUtilTest {
    ...
    public void testReadWriteValue() throws Exception {
        ...
        MealTestData.MEAL_MATHCER.assertEquals(MealTestData.ADMIN_MEAL, userMeal);
    }
    ...
    public void testReadWriteValues() throws Exception {
        ...
        MealTestData.MEAL_MATHCER.assertCollectionEquals(MealTestData.USER_MEALS, userMeals);
    }
}